...
// 길게 이어지는 Mock 데이터입니다.
// ReaderScreen 페이지 자동 분할 테스트용입니다.

// Deepflow는 집중 독서 데이터를 기반으로
// 사용자의 몰입 패턴을 분석합니다.

// 문장을 길게 이어붙여서
// 700자 이상이 되도록 만드는 중입니다.

// 이렇게 해야
// 페이지가 자동으로 여러 장 생성되는지
// UI를 확인할 수 있습니다.
...
//       console.log(
//         '🔥 TODAY 요청:',
//         `${API_CONFIG.BASE_URL}/reading/today`
//       );
...
//       const response =
//         await api.get(
//           `/reading/focus-analysis/${sessionId}`
//         );
